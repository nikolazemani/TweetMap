...
//        twitterSource.setFilterTerms(allTerms);
    ...
    public Application() {
        ...
        TimerTask bingAttributionCheck = new TimerTask() {
            ...
            public void run() {
                ...
                if (!bing.getAttributionText(0, coordinates, coordinates).equals("Error loading Bing attribution data")) {
                    map().setZoom(2);
                    bingTimer.cancel();
                }
            }
    ...
    private void doUIInitialization() {
    ...
    private void mouseHoverListener() {
        map().addMouseMotionListener(new MouseAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                ...
                if (markerList.size() >= 1 ) {
                    MapMarker mapMarker = markerList.get(markerList.size() - 1);
                    MapMarkerEnhanced mapMarkerEnhanced = (MapMarkerEnhanced) mapMarker;
                    String tweet = mapMarkerEnhanced.getTweet();
                    String profilePictureURL = mapMarkerEnhanced.getAvatarImgURL();
                    map().setToolTipText("<html><img src=" + profilePictureURL + " height=\"50\" width=\"50\">" + tweet + "</html>");
                }
