...
public class LiveTwitterSource extends TwitterSource {
    ...
    private void initializeTwitterStream() {
        ...
        TwitterAPIAuth twitterAPIAuth= TwitterAPIAuth.getInstance();
        cb.setOAuthConsumerKey(twitterAPIAuth.CONSUMER_KEY)
                .setOAuthConsumerSecret(twitterAPIAuth.CONSUMER_SECRET)
                .setOAuthAccessToken(twitterAPIAuth.ACCESS_TOKEN)
                .setOAuthAccessTokenSecret(twitterAPIAuth.ACCESS_TOKEN_SECRET);
