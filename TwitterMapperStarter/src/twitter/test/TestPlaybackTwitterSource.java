...
public class TestPlaybackTwitterSource {
    ...
    public void testSetup() {
        ...
        testSourceWithOneTerm(source, to);
        testSourceWithTwoTerms(source, to);
    }

    private void testSourceWithTwoTerms(PlaybackTwitterSource source, TestObserver to) {
    ...
    private void testSourceWithOneTerm(PlaybackTwitterSource source, TestObserver to) {
